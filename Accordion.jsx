    ...
    return (<>
            ...
            {panelData.map((data, index) => {
                return (<div key={index}>                
                        <Panel panelTitle={data.title} panelContent={data.content} showPanel={showPanel} activePanel={activePanel} index={index}/>
                        </div>);
