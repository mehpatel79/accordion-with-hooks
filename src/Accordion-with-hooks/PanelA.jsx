...
const PanelA = ({showPanel, activePanel, togglebtn, panelId}) =>{
    ...
    return(<div style={{border: "1px solid black", padding:"5px", margin:"0px 10px"}}>
            ...
            <button className="accordion-button" onClick={()=>showPanel(1)}>{(togglebtn)&&(panelId===1)?"-":"+"}</button>
            </div>
            {(activePanel === 1) && (togglebtn) && 
                <p>
