...
const PanelC = ({showPanel, activePanel, togglebtn, panelId}) =>{
    ...
    return(<div style={{border: "1px solid black", padding:"5px", margin:"0px 10px"}}>
            ...
            <button className="accordion-button" onClick={()=>showPanel(3)}>{(togglebtn)&&(panelId===3)?"-":"+"}</button>
             </div>
             {(activePanel === 3) &&  (togglebtn) &&
